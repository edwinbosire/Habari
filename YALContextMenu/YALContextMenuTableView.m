...
- (instancetype)init {
    ...
    if (self) {
        ...
        self.tableFooterView = [[UIView alloc] initWithFrame:CGRectMake(0.0f, 0.0f, 320.0f, 180.0f)]; //Zero rect footer to clear empty rows UITableView draws
        
        UITapGestureRecognizer *dismissViewOnTap = [[UITapGestureRecognizer alloc] initWithTarget:self action:@selector(removeFromSuperview)];
        [self.tableFooterView addGestureRecognizer:dismissViewOnTap];
    }
    return self;
}
