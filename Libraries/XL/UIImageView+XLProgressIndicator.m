              ...
              progressIndicatorCenterPoint:(CGPoint)indicatorCenter
{
    ...
    // !!!: hacky way to use faulty content types from server
    AFImageResponseSerializer *serializer = [AFImageResponseSerializer new];
    serializer.acceptableContentTypes = [serializer.acceptableContentTypes setByAddingObject:@"application/octet-stream"];
